export const posts = [
  ...
  },
  {
    ...
    content: `
        ...
        <h2>Sfaturi utile</h2>
        <ul>
          <li>Verifică textura și consistența</li>
          <li>Cumpără de la apicultori locali</li>
          <li>Evită produsele foarte ieftine</li>
          <li>Observă procesul de cristalizare</li>
        </ul>
  
        <p>
          Mierea naturală cristalizează în timp – acest lucru este un semn de
  ...
  },
  {
    ...
    content: `
        ...
        <p>
          Propolisul este o substanță rășinoasă colectată de albine din mugurii
          copacilor, îmbogățită cu enzime proprii.
        </p>
    
        <h2>Beneficiile propolisului</h2>
        <ul>
          <li>Susține sistemul imunitar</li>
          <li>Are proprietăți antibacteriene și antivirale</li>
          <li>Ajută la vindecarea rănilor</li>
          <li>Reduce inflamațiile</li>
        </ul>
    
        <h2>Cum se utilizează propolisul</h2>
        <p>
          Propolisul se consumă sub formă de tinctură, spray sau capsule, conform
